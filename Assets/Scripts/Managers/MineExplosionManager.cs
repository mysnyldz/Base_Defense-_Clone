...
namespace Managers
{
    public class MineExplosionManager : MonoBehaviour
    {
        ...
        [SerializeField] private BoxCollider mineBuyCollider;
        [SerializeField] private MineExplosionController explosionController;
        ...
        private void Start()
        {
            mineBuyCollider.size = new Vector3(0.27f, 0.1f, 0.27f);
        }
        ...
        private void Explosion()
        {
            ...
            if (_explosionTimer <= 0)
            {
                ...
                explosionController.ColliderClose();
